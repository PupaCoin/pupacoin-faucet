...
class AsmoneyAPI 
{
	...
	function TransferPPCN($btcaddress, $amount, $currency, $memo)
	{
	...
	//To transfer PPCN to multiple receivers and pay fee for once, pass btcaddress and amount parameters as array to the following function
	function TransferToManyPPCN($btcaddress, $amount, $currency, $memo)
	{
