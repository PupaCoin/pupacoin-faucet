...
//Change to mili pupacoin because asmoney get currencies based on milicoinfunction ChangetoMili($amount,$currency) {	switch ($currency) {		case "PPCN" :			$amount = $amount * 1000;			return $amount;		case "mPPCN" :			return $amount;		case "Satoshi" :			$amount = $amount / 10000;			return $amount;		case "LTC" :			$amount = $amount * 1000;			return $amount;		case "mLTC" :			return $amount;		case "DOGE" :			$amount = $amount * 1000;			return $amount;		case "mDOGE" :			return $amount;		case "PPC" :			$amount = $amount * 1000;			return $amount;		case "mPPC" :			return $amount;		case "DRK" :			$amount = $amount * 1000;			return $amount;		case "mDRK" :			return $amount;		}}
