            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Currency</label>
                    ...
                    <select class="form-control" name="currency">
                    	<option value="PPCN" <?php if($db->res['value']=='PPCN') echo 'selected'; ?>>PPCN</option>
                    	<option value="mPPCN" <?php if($db->res['value']=='mPPCN') echo 'selected'; ?>>mPPCN</option>
...
<?php $db->queryres("select * from tbl_config where header='requestcount'"); ?>
            <div class="form-group">
                <label for="exampleInputEmail1">Minimum PPCN Queue for withdrawal<small>Only for PPCN faucets</small></label>
