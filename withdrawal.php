...
if( isset($_POST['currency'] ) ){
	...
	$amount=$_POST['amount'];
	/*Bitcoin :  Transfer all payment in one transaction without fees | mPPCNLitecoin : 1% + 1 mLTCDogecoin : 1% + 1.0 DogePeercoin : 1% + 10 mPPCDarkcoin : 1% + 1 mDRK */

	switch ($curtype)
	{		
	case "PPCN" :			$fees = $amount;			break;
	case "mPPCN" :			$fees = $amount;			break;
